        ...
        <div className={cx('wrapper')}>
            <nav className={cx('menu')}>
                <NavLink to={config.routes.home} className={(nav) => cx('menu-link', { active: nav.isActive })} end>
                    <Button className={cx('menu-item')} leftIcon={<HomeIcon />} noneOutline>
                        <h2>For you</h2>
                    </Button>
                    <Button className={cx('menu-item', 'active-icon')} leftIcon={<HomeActiveIcon />} noneOutline>
                        <h2>For you</h2>
                    </Button>
                </NavLink>

                <NavLink to={config.routes.following} className={(nav) => cx('menu-link', { active: nav.isActive })}>
                    <Button className={cx('menu-item')} leftIcon={<UserGroupIcon />} noneOutline>
                        <h2>Following</h2>
                    </Button>
                    <Button className={cx('menu-item', 'active-icon')} leftIcon={<UserGroupActiveIcon />} noneOutline>
                        <h2>Following</h2>
                    </Button>
                </NavLink>

                <NavLink to={config.routes.live} className={(nav) => cx('menu-link', { active: nav.isActive })}>
                    <Button className={cx('menu-item')} leftIcon={<LiveIcon />} noneOutline>
                        <h2>Live</h2>
                    </Button>
                    <Button className={cx('menu-item', 'active-icon')} leftIcon={<LiveActiveIcon />} noneOutline>
                        <h2>Live</h2>
                    </Button>
                </NavLink>
            </nav>
            ...
            {isSignIn && (
                <div className={cx('sign-in')}>
                    ...
                    <Button outline className={cx('log-in-btn')} onClick={() => {
            ...
            <footer className={cx('sidebar-footer')}>
                <div className={cx('footer-content-list')}>
                    <Link to="/" className={cx('footer-content-item')}>
                        About
                    </Link>
                    <Link to="/" className={cx('footer-content-item')}>
                        Contact
